					...
					<form action="islemler/islem.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input type="text" class="form-control" required name="musteri_isim"
									value="<?php echo $kayitcek['musteri_isim'] ?>">
							</div>
							<div class="form-group col-md-4">
								<label>E-Posta</label>
								<input type="email" class="form-control" name="musteri_mail"
									value="<?php echo $kayitcek['musteri_mail'] ?>">
							</div>
							<div class="form-group col-md-4">
								<label>Telefon Numarası</label>
								<input type="number" class="form-control" name="musteri_telefon"
									value="<?php echo $kayitcek['musteri_telefon'] ?>">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Sipariş Başlığı</label>
								<input type="text" class="form-control" required name="sip_baslik"
									value="<?php echo $kayitcek['sip_baslik'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Sipariş Tamamlanma Yüzdesi</label>
								<input type="number" min="0" max="100" value="<?php echo $kayitcek['yuzde'] ?>"
									class="form-control" required name="yuzde" placeholder="Sipariş Tamamlanma Yüzdesi">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="number" class="form-control" required name="sip_ucret"
									value="<?php echo $kayitcek['sip_ucret'] ?>">
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input required type="date" class="form-control" name="sip_baslama_tarih"
									value="<?php echo $kayitcek['sip_baslama_tarih'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Teslim Tarihi</label>
								<input required type="date" class="form-control" name="sip_teslim_tarihi"
									value="<?php echo $kayitcek['sip_teslim_tarihi'] ?>">
							</div>
						</div>
						...
						<div class="form-row">
							<div class="col-md-6 mx-auto mt-3">
								...
								<div class="custom-control custom-checkbox small mt-2">
									<input type="checkbox" class="custom-control-input" value="sil" id="dosya_sil"
										name="dosya_sil">
						...
						<div class="form-row mt-2">
							<div class="form-group col-md-12">
								<textarea class="ckeditor" name="sip_detay"
									id="editor"><?php echo $kayitcek['sip_detay'] ?></textarea>
							</div>
						</div>
						<input type="hidden" class="form-control" name="sip_id"
							value="<?php echo $kayitcek['sip_id'] ?>">
						<div class="text-center">
							<button type="submit" name="siparisguncelle" class="btn btn-success btn-lg"><i

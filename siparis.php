					...
					<form action="islemler/islem.php" method="POST">
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input disabled="" type="text" class="form-control" name="musteri_isim"
									value="<?php echo $sipariscek['musteri_isim'] ?>">
							</div>
							<div class="form-group col-md-4">
								<label>E-Posta</label>
								<input disabled="" type="email" class="form-control" name="musteri_mail"
									value="<?php echo $sipariscek['musteri_mail'] ?>">
							</div>
							<div class="form-group col-md-4">
								<label>Telefon Numarası</label>
								<input disabled="" type="number" class="form-control" name="musteri_telefon"
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input disabled="" type="text" class="form-control" name="sip_baslik"
									value="<?php echo $sipariscek['sip_baslik'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Sipariş Tamamlanma Yüzdesi</label>
								<input type="number" min="0" max="100" disabled=""
									value="<?php echo $kayitcek['yuzde'] ?>" class="form-control" required name="yuzde"
									placeholder="Sipariş Tamamlanma Yüzdesi">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Ücret (TL)</label>
								<input disabled="" type="text" class="form-control" name="sip_ucret"
							...
							<div class="form-group col-md-6">
								...
								<input disabled type="date" class="form-control" name="sip_teslim_tarihi"
						...
						<div class="form-row">
							...
							<div disabled class="form-group col-md-6">
								...
								<input disabled type="text" class="form-control"
									value="<?php echo aciliyet()[$aciliyet] ?>">
							</div>

        ...
        <div class="p-5">
          ...
          <form class="user" action="islemler/islem.php" method="POST">
            <div class="form-group">
              <input name="kul_mail" required type="text" class="form-control form-control-user" id="exampleInputEmail"
            ...
            <button name="oturumac" type="submit" class="btn text-white btn-primary btn-user btn-block">Oturum
              Aç</button>
            <hr>

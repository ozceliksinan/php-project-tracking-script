      ...
      <form action="islemler/islem.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="date" class="form-control" required="" name="proje_baslama_tarihi"
              placeholder="Başlangıç Tarihi">
          </div>
          <div class="form-group col-md-6">
            <label>Bitirme Tarihi</label>
            <input type="date" class="form-control" required="" name="proje_teslim_tarihi"
              placeholder="Projenin Bitirilmesi Gereken Tarih">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="number" min="0" max="100" value="0" class="form-control" required name="yuzde"
              placeholder="Proje Tamamlanma Yüzdesi">
          </div>
        </div>

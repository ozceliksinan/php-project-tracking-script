					...
					<form action="islemler/islem.php" method="POST">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input disabled type="text" class="form-control" name="proje_baslik"
									value="<?php echo $projecek['proje_baslik'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Başlama Tarihi</label>
								<input disabled="" type="date" class="form-control" name="proje_baslama_tarihi"
									value="<?php echo $projecek['proje_baslama_tarihi'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Bitirme Tarihi</label>
								<input disabled type="date" class="form-control" name="proje_teslim_tarihi"
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="number" min="0" max="100" value="<?php echo $projecek['yuzde'] ?>"
									class="form-control" disabled name="yuzde" placeholder="Proje Tamamlanma Yüzdesi">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								<textarea disabled class="ckeditor"

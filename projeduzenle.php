					...
					<form action="islemler/islem.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input required type="text" class="form-control" name="proje_baslik"
									value="<?php echo $projecek['proje_baslik'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Başlama Tarihi</label>
								<input required type="date" class="form-control" name="proje_baslama_tarihi"
									value="<?php echo $projecek['proje_baslama_tarihi'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label>Bitirme Tarihi</label>
								<input required type="date" class="form-control" name="proje_teslim_tarihi"
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="number" min="0" max="100" value="<?php echo $projecek['yuzde'] ?>"
									class="form-control" required name="yuzde" placeholder="Proje Tamamlanma Yüzdesi">
							</div>
						</div>
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<textarea class="ckeditor" name="proje_detay"
									id="editor"><?php echo $projenindetaymetni; ?></textarea>
							</div>
						</div>
						<input type="hidden" class="form-control" name="proje_id"
							value="<?php echo $_POST['proje_id'] ?>">
						<button style="width: fit-content;" type="submit" name="projeguncelle"
